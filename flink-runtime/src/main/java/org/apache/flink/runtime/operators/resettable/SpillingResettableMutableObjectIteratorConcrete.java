 ...
 */
public class SpillingResettableMutableObjectIteratorConcrete<T> implements SpillingResettableMutableObjectIterator<T> {
	
	private static final Logger LOG = LoggerFactory.getLogger(SpillingResettableMutableObjectIteratorConcrete.class);
	...
	public SpillingResettableMutableObjectIteratorConcrete(MutableObjectIterator<T> input, TypeSerializer<T> serializer,
	...
	private SpillingResettableMutableObjectIteratorConcrete(MutableObjectIterator<T> input, TypeSerializer<T> serializer,
                                                            MemoryManager memoryManager, IOManager ioManager,
