 ...
 */
public class RecordWriterConcrete<T extends IOReadableWritable> implements RecordWriter<T> {

	private static final Logger LOG = LoggerFactory.getLogger(RecordWriterConcrete.class);
	...
	public RecordWriterConcrete(ResultPartitionWriter writer) {
		this(writer, new RoundRobinChannelSelector<T>(), (long)-1, null);
	}

	public RecordWriterConcrete(
