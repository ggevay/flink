 ...
 */
public class MapDriver3<IT, OT> implements Driver<MapFunction<IT, OT>, OT> {
	...
	public void run() throws Exception {
		...
		final MapFunction<IT, OT> function = this.taskContext.getStub(); //(MapFunction<IT, OT>)new Map3();
